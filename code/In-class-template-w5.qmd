...
Goal: to create a dataframe with median pH, median DO (mg/L), median salinity (ppt) for each date and site 
...
- create a new object from aq-in 
- clean column names 
...
- calculate average abundance per liter (sum counts divided by 7.5 L) 
- create a new column called 'date_site' to join with water quality 
- join data frames 
- join with taxon list 

```{r}
#| label: cleaning-aq-in 
#| message: false
#| warning: false 
